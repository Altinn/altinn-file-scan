...
namespace Altinn.FileScan.Repository.Interfaces
{
    ...
    public interface IAppOwnerBlob
    {
        ...
        public Task<Stream> GetBlob(string org, string blobPath, int? storageAccountNumber);
        ...
        public Task<BlobPropertyModel> GetBlobProperties(string org, string blobPath, int? storageAccountNumber);
    }
}
